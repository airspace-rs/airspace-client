...
public class Class5
{
    ...
    public static Class5 method159(int i)
    {
        ...
        aBuffer_60.pointer = anIntArray72[i];
        class5.aLong78 = i;
        class5.method165(true, aBuffer_60);
        return class5;
    }
    ...
    public Model method164(int i, int j, int k, int ai[])
    {
        if(anIntArray88 != null)
        {
            Class5 class5 = method161(anInt64);
        ...
        model_1.method464(7, model, Animation.method532(k, false) & Animation.method532(j, false));
        if(k != -1 && j != -1)
    ...
    public void method165(boolean flag, Buffer buffer)
    {
        if(!flag)
        ...
        do
        {
            ...
            if(i == 3)
                aByteArray89 = buffer.method416((byte)30);
            else
            if(i == 12)
            ...
            if(i == 90)
                anInt96 = buffer.method410();
            else
            if(i == 91)
                anInt71 = buffer.method410();
            else
            if(i == 92)
                anInt90 = buffer.method410();
            else
            if(i == 93)
                aBoolean87 = false;
            else
